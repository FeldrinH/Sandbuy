...
game.AddAmmoType({name = "ArmorkitBattery"})

if CLIENT then
	language.Add("ArmorkitBattery_ammo", "Armorkit Suit Battery")
end

SWEP.PrintName = "Armorkit"
SWEP.Author = "robotboy655 & MaxOfS2D (Modified by FeldrinH)"
SWEP.Purpose = "Armor people with your primary attack, or yourself with the secondary. Buy refills for money."
...
SWEP.ViewModel = Model( "models/weapons/c_armorkit.mdl" )
SWEP.WorldModel = Model( "models/weapons/w_armorkit.mdl" )
...
SWEP.Primary.Ammo = "ArmorkitBattery"
...
function SWEP:PrimaryAttack()
	...
	if ( IsValid( ent ) && need > 0 && ent:IsPlayer() && ent:Armor() < 100 ) then
...
function SWEP:SecondaryAttack()
	...
	if ( IsValid( ent ) && need > 0 && ent:Armor() < 100 ) then
